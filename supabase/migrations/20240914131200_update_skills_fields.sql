-- Add skills_other field to store additional details
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS skills_other TEXT DEFAULT NULL;

-- Update the update_profile function to handle skills_other
